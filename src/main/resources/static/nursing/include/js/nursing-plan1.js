...
var selectPatientWidget = Vue.component('nursing-plan1', {
    ...
    data: function () {
      return {
        ...
        list: [],
        selectedOne:{},
		form:{id:"",nursingDate:'',items:"",isFee:true,operator:"",checker:"",somethings:""},
		currentPage:0,
		pageSize:10,
		totalNum:0,
		isShowEdit:false
	...
	template: `
			<div>
				...
				<el-table :data="list" style="width: 100%" stripe="true">
					...
					<el-table-column label="采血日期" width="100">
					...
					<el-table-column label="功能">
						<template slot-scope="scope">
							<span>{{ scope.row.somethings }}</span>
						</template>
					</el-table-column>
						...
						<el-row :gutter="10">
							<el-col :span="24">
								<el-form-item label="功能">						
									<el-input type="input" v-model="form.somethings" size="mini"></el-input>
								</el-form-item>
							</el-col>
						</el-row>
					</el-form>
    ...
    methods: {
		initform(){
			this.form={id:"",isFee:true,patientid:"",nursingDate:'',items:"",nursingNote:"",nurseFullname:"",nurseName:""}
		},
		newRecord(){
			this.initform();
